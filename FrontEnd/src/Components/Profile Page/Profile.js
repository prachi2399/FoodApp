...
function Profile() {
    ...
    // const { user } = useAuth();
    const [user,setUser] = useState(JSON.parse(localStorage.getItem("user")).userDetails);
    useEffect(async ()=>{
        ...
        <div className="container-grey">
            <div className="form-container">
                ...
                <div className="loginBox">
                    ...
                    <button className="loginBtn  form-button" type="submit" onClick={handleDeleteClick}>
                        Delete Profile
                    </button>
                </div>
            </div>
